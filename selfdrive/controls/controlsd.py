...
class Controls:
  ...
  def publish_logs(self, CS, start_time, actuators, v_acc, a_acc, lac_log, CS_arne182):
    ...
    if len(meta.desirePrediction) and ldw_allowed:
      ...
      l_lane_close = left_lane_visible and (self.sm['pathPlan'].lPoly[3] < (0.85 - CAMERA_OFFSET))
      r_lane_close = right_lane_visible and (self.sm['pathPlan'].rPoly[3] > -(0.95 + CAMERA_OFFSET))
