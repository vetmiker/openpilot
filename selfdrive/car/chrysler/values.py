...
DBC = {
  ...
  CAR.JEEP_CHEROKEE_2018: dbc_dict(  # Same DBC file works.
    'chrysler_pacifica_2018_hybrid',  # 'pt'
    'chrysler_pacifica_2017_hybrid_private_fusion'),  # 'radar'
